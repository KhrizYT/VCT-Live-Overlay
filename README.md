# VLR Overlay for VCT Matches · v5.4

> v5.4 corrige el modo LIVE del overlay (ya no se mezcla con STARTS IN), refuerza la detección de matches terminadas usando match/details + results, y mantiene el Studio público de una sola página sin rooms ni panel privado.

## Cambios principales de v5.4
